                                    ...
                                    int make_copy )
{
            ...
            MBEDTLS_ASN1_CONSTRUCTED | MBEDTLS_ASN1_SEQUENCE ) ) != 0 )
    {
        ...
        printf("INVALID FORMATE 1 ret = %d\n", ret);
    ...
    {
        mbedtls_x509_crt_free( crt );
        printf("INVALID FORMATE 2 ret = %d\n", ret);
    ...
    {
        mbedtls_x509_crt_free( crt );
        printf("INVALID FORMATE 3 ret = %d\n", ret);
        return( MBEDTLS_ERR_X509_INVALID_FORMAT + ret );
    }
    ...
    {
        mbedtls_x509_crt_free( crt );
        printf("INVALID FORMATE 4 ret = %d\n", ret);
        return( MBEDTLS_ERR_X509_INVALID_FORMAT + ret );
    }
    ...
    {
        mbedtls_x509_crt_free( crt );
        printf("INVALID FORMATE 5 ret = %d\n", ret);
        return( MBEDTLS_ERR_X509_INVALID_FORMAT +
                MBEDTLS_ERR_ASN1_LENGTH_MISMATCH );
    }
    ...
    {
        mbedtls_x509_crt_free( crt );
        printf("INVALID FORMATE 6 ret = %d\n", ret);
        return( MBEDTLS_ERR_X509_INVALID_FORMAT +
                MBEDTLS_ERR_ASN1_LENGTH_MISMATCH );
    }
    ...
    if( buf_format == MBEDTLS_X509_FORMAT_PEM )
    {
        ...
        while( buflen > 1 )
        {
            ...
            else if( ret != MBEDTLS_ERR_PEM_NO_HEADER_FOOTER_PRESENT )
            {
                ...
                break;
            // printf("pem.buf = \n");
            // for(num = 0; num < pem.buflen; num++)
            //     printf("%02X", pem.buf[num]);
            // printf("pem.buf end\n");
